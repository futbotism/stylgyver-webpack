...
var ComponentMetaGenerator = /** @class */ (function (_super) {
    __extends(ComponentMetaGenerator, _super);
    function ComponentMetaGenerator(path) {
    ...
    ComponentMetaGenerator.prototype.parseLines = function () {
        var _this = this;
    ...
    ComponentMetaGenerator.prototype.buildFileMeta = function () {
        return {
            id: this.id,
            title: this.title,
    ...
    return ComponentMetaGenerator;
}(classes_1.FileScan));
exports.ComponentMetaGenerator = ComponentMetaGenerator;
